![](attachments/General%20Skills-10.png)
...
generate a custom word-list using CUPP;

![](attachments/General%20Skills-11.png)

rename the file to passwords.txt and move to same directory of script
